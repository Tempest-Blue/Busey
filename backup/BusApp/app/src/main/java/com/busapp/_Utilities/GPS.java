...
public class GPS {
    ...
    public static void initializeGPS(final Context context) {
        ...
        if (mGoogleApiClient == null) {
            Log.d("testing", "mGoogleApiClient == null");
    ...
    public static void getUsersLocation(final Context context, final OnLocationReceivedListener listener) {
        ...
        Log.d("testing", "getUsersLocation");
        ...
        {
            Log.d("testing", "not connected, initializing");
        ...
        {
            Log.d("testing", "getting location");

            LocationRequest mLocationRequest = LocationRequest.create();
            mLocationRequest.setPriority(LocationRequest.PRIORITY_HIGH_ACCURACY);

            Log.d("testing", "getting location now");
